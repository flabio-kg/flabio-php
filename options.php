...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __( 'Настройки главной страницы', 'theme-textdomain' ),
		'type' => 'heading'
	);
        

	$options[] = array(
		'name' => __( 'Публичный Email', 'theme-textdomain' ),
		'desc' => __( 'Введите необходимый адрес', 'theme-textdomain' ),
		'id' => 'head_email',
		'std' => 'mail@mail.ru',
		'class' => 'mini',
		'type' => 'text'
        ...
        $options[] = array(
		'name' => __( 'Логотип', 'theme-textdomain' ),
		'desc' => __( 'Загрузите логотип', 'theme-textdomain' ),
		'id' => 'logo_top',
		'type' => 'upload'
	);
        
        $options[] = array(
		'name' => __( 'Текст в шапке', 'theme-textdomain' ),
		'desc' => __( 'Введите текст', 'theme-textdomain' ),
		'id' => 'text_top',
		'std' => 'мы создаём и заряжаем',
		'type' => 'text'
	);    
        
        $options[] = array(
		'name' => __( 'Динамичный текст', 'theme-textdomain' ),
		'desc' => __( 'Введите текст в ковычках и через запятую', 'theme-textdomain' ),
		'id' => 'script_text',
		'std' => 'текст',
		'type' => 'textarea'
	);
...
//	);
	...
	$options[] = array(
		'name' => __( 'Настройки футера', 'theme-textdomain' ),
		'type' => 'heading'
	);
        
        $options[] = array(
		'name' => __( 'Копирайт', 'theme-textdomain' ),
		'desc' => __( 'Введите текст копирайта в футере.', 'theme-textdomain' ),
		'id' => 'copy_text',
		'std' => '«Flabio» 2017. Все права защищены.',
		'type' => 'textarea'
	);
        
	$options[] = array(
		'name' => __( 'Логотип футера', 'theme-textdomain' ),
		'desc' => __( 'Загрузите логотип', 'theme-textdomain' ),
		'id' => 'footer_logo',
		'type' => 'upload'
	);
        ...
        $options[] = array(
		'name' => __( 'Соц.сети', 'theme-textdomain' ),
		'desc' => __( 'Введите текст соц.сетей в футере.', 'theme-textdomain' ),
		'id' => 'soc_text',
		'std' => 'Свяжитесь с нами',
		'type' => 'text'
	);
        
        $options[] = array(
		'name' => __( 'Социальные сети', 'theme-textdomain' ),
		'type' => 'heading'
	);
        
        $options[] = array(
		'name' => __( 'Facebook', 'theme-textdomain' ),
		'desc' => __( 'Ссылка на страницу Facebook', 'theme-textdomain' ),
		'id' => 'soc_fb',
		'std' => 'https://facebook.com/user',
		'type' => 'text'
	);
        
        $options[] = array(
		'name' => __( 'Vkontakte', 'theme-textdomain' ),
		'desc' => __( 'Ссылка на страницу Vkontakte', 'theme-textdomain' ),
		'id' => 'soc_vk',
		'std' => 'https://vk.com/user',
		'type' => 'text'
	);
        
        $options[] = array(
		'name' => __( 'Instagram', 'theme-textdomain' ),
		'desc' => __( 'Ссылка на страницу Instagram', 'theme-textdomain' ),
		'id' => 'soc_ins',
		'std' => 'https://facebook.com/user',
		'type' => 'text'
	);
        ...
        $options[] = array(
		'name' => __( 'Google plus', 'theme-textdomain' ),
		'desc' => __( 'Ссылка на страницу Google plus', 'theme-textdomain' ),
		'id' => 'soc_gl',
		'std' => 'https://google.com/user',
		'type' => 'text'
	);
        
        $options[] = array(
		'name' => __( 'Telegram', 'theme-textdomain' ),
		'desc' => __( 'Ссылка на страницу Telegram', 'theme-textdomain' ),
		'id' => 'soc_tg',
		'std' => 'https://t.me/user',
		'type' => 'text'
	);
